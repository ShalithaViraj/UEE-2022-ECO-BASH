...
class ViewMoreSoilType extends StatefulWidget {
  const ViewMoreSoilType({Key? key, required this.SoiltypeKey})
      : super(key: key);

  final String SoiltypeKey;

  @override
  State<ViewMoreSoilType> createState() => _ViewMoreSoilTypeState();
}

class _ViewMoreSoilTypeState extends State<ViewMoreSoilType> {
  ...
  void getorganicData() async {
    ...
    organicidController.text = organic['soiltypeid'];
    organicnameController.text = organic['soiltypename'];
    descriptionController.text = organic['soiltypedesd'];
    oragnicImageController.text = organic['soiltypeimage'];
  }
