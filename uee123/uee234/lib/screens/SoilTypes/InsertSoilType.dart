...
class InsertSoilType extends StatefulWidget {
  const InsertSoilType({Key? key}) : super(key: key);
  

  @override
  State<InsertSoilType> createState() => _InsertSoilTypeState();
}

class _InsertSoilTypeState extends State<InsertSoilType> {
    // ignore: deprecated_member_use
    final _formKey = GlobalKey<FormState>();
    final databaseRef = FirebaseDatabase.instance.ref().child('SoilType');
             ...
             SizedBox(
              ...
              TextFormField(
               ...
               TextFormField(
                  ...
                  hintText: 'Insert Soil Type Description',
                  ...
                  String id  = DateTime.now().millisecondsSinceEpoch.toString() ;
                    databaseRef.child(id)
                      // .child(date.toString()).set({
                        .set({
                           'soiltypeid': SoilTypeidController.text.toString(),
                          'soiltypename':SoilTypenameController.text.toString(),
                           'soiltypedesd':SoilTypedescriptionController.text.toString(),
                           'soiltypeimage':downloadURL.toString(),
                    ...
                    // 'desd':titleController.text.toString(),
                      ...
                      toastMessage ('Soil Type Added Successfully');
                      ...
                      toastMessage ('Soil Type Added Failed');
                           setState(() {
                            loading = false ;
                           });
