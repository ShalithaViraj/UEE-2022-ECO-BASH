...
class InsertSoilErosion extends StatefulWidget {
  const InsertSoilErosion({Key? key}) : super(key: key);
  

  @override
  State<InsertSoilErosion> createState() => _InsertSoilErosionState();
}

class _InsertSoilErosionState extends State<InsertSoilErosion> {
    // ignore: deprecated_member_use
    final _formKey = GlobalKey<FormState>();
    final databaseRef = FirebaseDatabase.instance.ref().child('Erosion');
             ...
             SizedBox(
              ...
              TextFormField(
               ...
               TextFormField(
                  ...
                  hintText: 'Insert Soil Erosion Description',
                  ...
                  String id  = DateTime.now().millisecondsSinceEpoch.toString() ;
                    databaseRef.child(id)
                      // .child(date.toString()).set({
                        .set({
                           'erosionid': ErosionidController.text.toString(),
                          'erosionname':ErosionnameController.text.toString(),
                           'erosiondesd':ErosiondescriptionController.text.toString(),
                           'erosionimage':downloadURL.toString(),
                    ...
                    // 'desd':titleController.text.toString(),
                      ...
                      toastMessage ('Soil Erosion Methods Added Successfully');
