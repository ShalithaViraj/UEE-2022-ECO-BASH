...
class InsertSoilCon extends StatefulWidget {
  const InsertSoilCon({Key? key}) : super(key: key);
  

  @override
  State<InsertSoilCon> createState() => _InsertSoilConState();
}

class _InsertSoilConState extends State<InsertSoilCon> {
    // ignore: deprecated_member_use
    final _formKey = GlobalKey<FormState>();
    final databaseRef = FirebaseDatabase.instance.ref().child('SoilConservation');
             ...
             SizedBox(
              ...
              TextFormField(
               ...
               TextFormField(
                  ...
                  hintText: 'Insert Soil Conservation Description',
                  ...
                  String id  = DateTime.now().millisecondsSinceEpoch.toString() ;
                    databaseRef.child(id)
                      // .child(date.toString()).set({
                        .set({
                           'soilconid': SoilConidController.text.toString(),
                          'soilconname':SoilConnameController.text.toString(),
                           'soilcondesd':SoilCondescriptionController.text.toString(),
                           'soilconimage':downloadURL.toString(),
