...
class editErosionRecord extends StatefulWidget {
  
  const editErosionRecord({Key? key, required this.SoilConKey}) : super(key: key);
 
  final String SoilConKey;
 
  @override
  State<editErosionRecord> createState() => _editErosionRecordState();
}
 
class _editErosionRecordState extends State<editErosionRecord> {
 ...
 final SoilConidController = TextEditingController();
  ...
  void initState() {
    super.initState();
    dbRef = FirebaseDatabase.instance.ref().child('Erosion');
    getorganicData();
  }
  ...
  void getorganicData() async {
    ...
    SoilConidController.text = soilType['erosionid'];
    SoilConnameController.text = soilType['erosionname'];
    SoilCondescriptionController.text = soilType['erosiondesd'];
                  ...
                  children: [
                    ...
                    fontSize: 16,
                     ...
                     decoration: InputDecoration(
                      ...
                      hintText: 'Insert Soil Erosion Name',
                      border: OutlineInputBorder(
                        borderRadius: BorderRadius.circular(10),
                      ),
                       disabledBorder: OutlineInputBorder(
                    ...
                    MaterialButton(
                      onPressed: () {
                        ...
                        Map<String, String> SoilType = {
                          'erosionid': SoilConidController.text,
                          'erosionname': SoilConnameController.text,
                          'erosiondesd': SoilCondescriptionController.text
                        };
