...
class InsertBacteria extends StatefulWidget {
  const InsertBacteria({Key? key}) : super(key: key);
  

  @override
  State<InsertBacteria> createState() => _InsertBacteriaState();
}

class _InsertBacteriaState extends State<InsertBacteria> {
    // ignore: deprecated_member_use
    final _formKey = GlobalKey<FormState>();
    final databaseRef = FirebaseDatabase.instance.ref().child('Bacteria');
              ...
              SizedBox(
               ...
               RoundButton(title: 'Submit', loading: loading,
                    ...
                    databaseRef.child(id)
                        ...
                        .set({
                           'bacteriaid': BacteriaidController.text.toString(),
                          'bacterianame':BacterianameController.text.toString(),
                           'bacteriadesd':BacteriadescriptionController.text.toString(),
                           'bacteriaimage':downloadURL.toString(),
                      ...
                      toastMessage ('Bacteria Added Successfully');
                      Navigator.push(
                                context,
                                MaterialPageRoute(
                      ...
                      toastMessage ('Bacteria Added Failed');
                           setState(() {
                            loading = false ;
                           });
