...
import 'package:uee234/screens/SoilAnimals/FungleViewMore.dart';


 
class FungleClientData extends StatefulWidget {
  const FungleClientData({Key? key}) : super(key: key);
 
  @override
  State<FungleClientData> createState() => _FungleClientDataState();
}
 
class _FungleClientDataState extends State<FungleClientData> {
      ...
      child: Column(
        ...
        Container(
          ...
          child: MaterialButton(
            ...
            onPressed: 
            () {
             Navigator.push(context, MaterialPageRoute(builder: (_) => ViewMoreFungle(FungleKey: Bacteria['key'])));
            },
            ),
        )
        ]
