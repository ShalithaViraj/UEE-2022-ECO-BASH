...
class ViewMoreBacteria extends StatefulWidget {
  const ViewMoreBacteria({Key? key, required this.BacteriaKey})
      : super(key: key);

  final String BacteriaKey;

  @override
  State<ViewMoreBacteria> createState() => _ViewMoreBacteriaState();
}

class _ViewMoreBacteriaState extends State<ViewMoreBacteria> {
  ...
  void getorganicData() async {
    ...
    organicidController.text = organic['bacteriaid'];
    organicnameController.text = organic['bacterianame'];
    descriptionController.text = organic['bacteriadesd'];
    oragnicImageController.text = organic['bacteriaimage'];
  }
