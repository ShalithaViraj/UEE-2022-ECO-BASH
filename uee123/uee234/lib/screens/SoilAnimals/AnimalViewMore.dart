...
class ViewMoreAnimal extends StatefulWidget {
  const ViewMoreAnimal({Key? key, required this.SoilAnimalKey})
      : super(key: key);

  final String SoilAnimalKey;

  @override
  State<ViewMoreAnimal> createState() => _ViewMoreChemicalState();
}

class _ViewMoreChemicalState extends State<ViewMoreAnimal> {
  ...
  void getorganicData() async {
    ...
    organicidController.text = organic['animalid'];
    organicnameController.text = organic['animalname'];
    descriptionController.text = organic['animaldesd'];
    oragnicImageController.text = organic['animalimage'];
  }
