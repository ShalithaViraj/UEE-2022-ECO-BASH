...
class ViewMoreoraganic extends StatefulWidget {
  const ViewMoreoraganic({Key? key, required this.OrganicKey})
      : super(key: key);

  final String OrganicKey;

  @override
  State<ViewMoreoraganic> createState() => _ViewMoreoraganicState();
}

class _ViewMoreoraganicState extends State<ViewMoreoraganic> {
  ...
  void getorganicData() async {
    ...
    oragnicImageController.text = organic['pimage'];
  }
