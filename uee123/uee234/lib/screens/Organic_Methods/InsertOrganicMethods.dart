...
class InsertOrganic extends StatefulWidget {
  const InsertOrganic({Key? key}) : super(key: key);
  

  @override
  State<InsertOrganic> createState() => _InsertOrganicState();
}

class _InsertOrganicState extends State<InsertOrganic> {
    // ignore: deprecated_member_use
    final _formKey = GlobalKey<FormState>();
    final databaseRef = FirebaseDatabase.instance.ref().child('Organic');
                  ...
                  String id  = DateTime.now().millisecondsSinceEpoch.toString() ;
                    databaseRef.child(id)
                      // .child(date.toString()).set({
                        .set({
                           'oid':organicidController.text.toString(),
                          'oname':organicnameController.text.toString(),
                           'desd':descriptionController.text.toString(),
                    ...
                    // 'desd':titleController.text.toString(),
                      ...
                      toastMessage ('Post Added Failed');
                           setState(() {
                            loading = false ;
                           });
