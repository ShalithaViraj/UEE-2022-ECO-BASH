...
import 'package:uee234/screens/Organic_Methods/EditChemical.dart';
import 'package:uee234/screens/Organic_Methods/EditOrganic.dart';
import 'package:uee234/screens/Organic_Methods/InsertChemical.dart';
...
class ChemicalAdminData extends StatefulWidget {
  const ChemicalAdminData({Key? key}) : super(key: key);
 
  @override
  State<ChemicalAdminData> createState() => _ChemicalAdminDataState();
}
 
class _ChemicalAdminDataState extends State<ChemicalAdminData> {
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    GestureDetector(
                      onTap: () {
                       Navigator.push(context, MaterialPageRoute(builder: (_) => editChemicalRecord(ChemicalKey: Chemicals['key'])));
                      },
                      child: Row(
                        children: [
                          Icon(
                    ...
                    GestureDetector(
                      onTap: () {
                        reference.child(Chemicals['key']).remove();
                      },
                      child: Row(
                        children: [
                          Icon(
      ...
      body: 
          Column(
            ...
            Container(
              ...
              child: IconButton(
                onPressed:() {
                   Navigator.push(context, MaterialPageRoute(builder: (context) => InsertChemical()));
                },
